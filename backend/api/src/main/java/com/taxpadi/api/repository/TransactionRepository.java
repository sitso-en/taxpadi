...
public interface TransactionRepository extends JpaRepository<Transaction, UUID> {
    ...
    @Query(value = """
      ...
      WHERE is_active = true
        ...
        AND (CAST(:taxDeductible AS BOOLEAN) IS NULL OR tax_deductible = CAST(:taxDeductible AS BOOLEAN))
        AND (CAST(:withholdingApplicable AS BOOLEAN) IS NULL OR withholding_applicable = CAST(:withholdingApplicable AS BOOLEAN))
